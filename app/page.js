...
const HomePage = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col overflow-hidden">
      <PromotionalPopup setHeaderVisible={setHeaderVisible} />
      {headerVisible && (
            ...
            <div className="flex flex-col justify-center w-full">
              <div className="flex flex-col gap-2  text-center md:text-left">
                <h3 className="font-bold text-2xl md:text-3xl lg:text-4xl">
                  LAGREE FAN{" "}
                  <span className="italic text-[#C8B682]">SOFIA VERGARA</span>{" "}
                  AND FOUNDER{" "}
                ...
                <p className="text-sm sm:text-base md:text-lg text-gray-700">
                  Sofia Vergara has been training with MegaFormer for many
                  years. She took a moment from her busy schedule to chat with
                  Sebastien Lagree.
                </p>
              </div>
            </div>
              ...
              <div className="flex flex-col gap-5 md:gap-8 text-center md:text-left">
                ...
                <div className="flex flex-col gap-1">
                  <p className="text-sm sm:text-base md:text-lg">
                    Activating slow-twitch muscle fibres builds lean muscle
                    mass, boosting metabolism for up to 24 hours post-class.
                  </p>

                  <p className="text-sm sm:text-base md:text-lg">
                    Patented equipment uses variable resistance and your own
                    body weight to target slow-twitch fibres, keeping muscles
            ...
            <div className="flex flex-col justify-center items-center w-full">
              <div className="flex flex-col justify-start items-start gap-2 ">
                <h1 className="font-bold text-3xl sm:text-5xl md:text-6xl lg:text-6xl ">
                  Where results <br className="hidden sm:block" /> meet
                  precision
                </h1>
